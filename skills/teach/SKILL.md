...
name: teach
description: >-
  Starting point for learning any subject. Use this skill when the user wants to learn something but hasn't specified how
  (e.g., "Teach me game theory", "Help me understand immunology", "I want to learn macroeconomics", "Plan a study path for
  organic chemistry", "Test my knowledge on constitutional law") or explicitly calls @teach. Figures out what the user needs
  and routes them to the right teaching approach — whether that's building intuition, practicing problems, planning a study
  schedule, or taking a test.
---
